...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post currencies_url, params: { currency: { name: @currency.name, ruble_rate: @currency.ruble_rate, usd_rate: @currency.usd_rate } }, as: :json
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { name: @currency.name, ruble_rate: @currency.ruble_rate, usd_rate: @currency.usd_rate } }, as: :json
    assert_response 200
  end
