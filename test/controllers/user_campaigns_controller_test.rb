...
class UserCampaignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_campaign" do
    assert_difference('UserCampaign.count') do
      post user_campaigns_url, params: { user_campaign: { campaign_id: @user_campaign.campaign_id, status: @user_campaign.status, user_id: @user_campaign.user_id } }, as: :json
    end
  ...
  test "should update user_campaign" do
    patch user_campaign_url(@user_campaign), params: { user_campaign: { campaign_id: @user_campaign.campaign_id, status: @user_campaign.status, user_id: @user_campaign.user_id } }, as: :json
    assert_response 200
  end
